...
{
    /// <summary>
    /// CacheStrategy.Permanent/Temporary
    /// Weak reference automatic recycle
    /// </summary>
    /// <typeparam name="TKey"></typeparam>
    /// <typeparam name="TValue"></typeparam>
    internal sealed class AdvancedCache<TKey, TValue>
    {
        ...
        public AdvancedCache(IEqualityComparer<TKey> equalityComparer)
        {
        ...
        #region Contains Key
        /// <summary>
        ///is contains key from the cache using the given key.
        /// </summary>
